...
export function ContactSection() {
    return (
        ...
        >
            ...
            <p className="text-white/70 mb-12 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                ...
                {CONTACTS.map(({ name, icon: Icon, url, available }) => (
                    available ? (
                        <a
                            ...
                            className="group flex flex-col items-center justify-center p-6 bg-black/40 border border-white/20 rounded-lg hover:border-white hover:bg-white/10 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] transition-all duration-300"
                        >
                        ...
                        <div
                            key={name}
                            className="flex flex-col items-center justify-center p-6 bg-black/20 border border-white/10 rounded-lg cursor-not-allowed"
                        >
